...
export default function Dashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            setError('Error al cargar datos del dashboard. Verifica la conexión con el servidor.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div style={{ 
            ...
            <div style={{ 
                ...
                {/* Ventas Mensuales Chart — datos reales */}
                <div style={{
                    ...
                    {ventasMensuales.length === 0 ? (
                        <div style={{ textAlign: 'center', color: '#94a3b8', padding: '3rem 0' }}>
                            ...
                            <p>Sin ventas en los últimos 6 meses</p>
                        </div>
                    ) : (
                ...
                <div style={{ background: 'white', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', border: '1px solid #e2e8f0' }}>
                    ...
                    {categoriasData.length === 0 ? (
                        <div style={{ textAlign: 'center', color: '#94a3b8', padding: '2rem 0' }}>
                            ...
                            <p style={{ margin: 0, fontSize: '0.875rem' }}>Sin ventas registradas por categoría</p>
                        </div>
                    ) : (
