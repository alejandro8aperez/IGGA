...
export const PERMISOS_ROL = {
    ...
    Gerente:       ['dashboard', 'crm', 'ventas', 'compras', 'finanzas', 'contabilidad',
                    ...
                    'inventario', 'productos', 'logistica', 'activos', 'kave', 'multi-empresa'],
    Contador:      ['dashboard', 'contabilidad', 'finanzas', 'tesoreria', 'facturacion',
                    'reportes', 'compras'],
    'Jefe Producción': ['dashboard', 'produccion', 'mrp', 'inventario', 'productos', 'compras',
                        'operaciones', 'mantenimiento', 'calidad'],
    Vendedor:      ['dashboard', 'crm', 'ventas', 'facturacion', 'inventario', 'productos', 'cotizador'],
    Comprador:     ['dashboard', 'compras', 'inventario', 'productos', 'proveedores'],
    Almacenista:   ['dashboard', 'inventario', 'productos', 'logistica', 'compras'],
    Técnico:       ['dashboard', 'mantenimiento', 'activos', 'operaciones'],
    RH:            ['dashboard', 'rrhh', 'configuracion'],
    Planificador:  ['dashboard', 'mrp', 'produccion', 'inventario', 'productos', 'operaciones'],
    Invitado:      ['dashboard'],
};
