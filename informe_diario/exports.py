...
def generar_excel(informe) -> bytes:
    ...
    _merge_and_write(ws, row, 1, 2, 'PROFESIONAL No 1', signature_label, light_fill, center_mid, cell_border)
    _fill_range(ws, row, 3, 4, fill=light_fill, border=cell_border)
    _merge_and_write(ws, row, 3, 4, 'PROFESIONAL No 2', signature_label, light_fill, center_mid, cell_border)
    _fill_range(ws, row, 5, 6, fill=light_fill, border=cell_border)
    _merge_and_write(ws, row, 5, 6, 'ELABORADO POR', signature_label, light_fill, center_mid, cell_border)
    _fill_range(ws, row, 7, 8, fill=light_fill, border=cell_border)
    _merge_and_write(ws, row, 7, 8, 'REVISADO POR', signature_label, light_fill, center_mid, cell_border)
    ...
    _merge_and_write(ws, row, 1, 2, profesional1_nombre, signature_name, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 3, 4, border=cell_border)
    _merge_and_write(ws, row, 3, 4, profesional2_nombre, signature_name, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 5, 6, border=cell_border)
    _merge_and_write(ws, row, 5, 6, elaborado_nombre, signature_name, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 7, 8, border=cell_border)
    _merge_and_write(ws, row, 7, 8, revisado_nombre, signature_name, white_fill, center_mid, cell_border)
    ...
    _fill_range(ws, row, 1, 2, border=cell_border)
    _merge_and_write(ws, row, 1, 2, profesional1_cargo, signature_cargo, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 3, 4, border=cell_border)
    _merge_and_write(ws, row, 3, 4, profesional2_cargo, signature_cargo, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 5, 6, border=cell_border)
    _merge_and_write(ws, row, 5, 6, elaborado_cargo, signature_cargo, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 7, 8, border=cell_border)
    _merge_and_write(ws, row, 7, 8, revisado_cargo, signature_cargo, white_fill, center_mid, cell_border)
    _fill_range(ws, row, 9, 10, border=cell_border)
